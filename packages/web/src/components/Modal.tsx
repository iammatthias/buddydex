  ...
  return (
    <div className="overlay" onClick={onClose}>
      <div className="modal" data-rarity={result.rarity} onClick={e => e.stopPropagation()}>
        ...
        <div className="note">
          Name and personality are generated by Claude on first hatch — they're not
          deterministic from the seed. Use <code>buddydex name</code> to change them after injecting.
        </div>
        <div className="seed">
